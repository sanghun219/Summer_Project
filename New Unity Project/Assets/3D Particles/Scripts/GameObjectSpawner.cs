...
public class GameObjectSpawner : MonoBehaviour
{
    ...
    private string currentGOInfo;	//Current particle info
    private GameObject currentGO;	//GameObject currently on stage
    private Color currentColor;
    private bool isPS;          //Toggle to check if this is a PS or a GO
    ...
    public void OnGUI()
    {
        ...
        if (image != null)
        {
            var tmp_cs1 = image.pixelsPerUnitMultiplier;
            tmp_cs1 = (float)((Screen.width) - (int)(image.flexibleWidth));
            image.pixelsPerUnitMultiplier = tmp_cs1;
        }
    }
